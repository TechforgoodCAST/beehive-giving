class InitSchema < ActiveRecord::Migration[5.0]
  def up
    ...
    create_table "answers", id: :serial do |t|
    ...
    create_table "countries_funds", id: :serial do |t|
    ...
    create_table "countries_geo_areas", id: false do |t|
    ...
    create_table "countries_proposals", id: :serial do |t|
      t.integer "country_id"
    ...
    create_table "criteria", id: :serial do |t|
    ...
    create_table "districts_funds", id: :serial do |t|
    ...
    create_table "districts_geo_areas", id: false do |t|
    ...
    create_table "districts_proposals", id: :serial do |t|
      t.integer "district_id"
      t.integer "proposal_id"
    ...
    create_table "funds", id: :serial do |t|
      t.integer "funder_id"
      t.string "name"
      t.text "description"
      t.string "slug"
    ...
    create_table "proposals", id: :serial do |t|
    ...
    create_table "recipients", id: :serial do |t|
      t.string "name"
      t.string "website"
      t.string "charity_number"
      t.string "company_number"
    ...
    create_table "users", id: :serial do |t|
      ...
      t.string "organisation_type", default: "Recipient"
