...
class RecipientFeedbackTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    setup_funders(4)
    create(:proposal, recipient: @recipient, countries: @countries, districts: @districts, age_groups: @age_groups, beneficiaries: @beneficiaries, implementations: @implementations)
  end
