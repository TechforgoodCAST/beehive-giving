...
EnquiriesHelpers = ((w, d) ->
  ...
  clickApproach = ->
    $('.approach-funder').on 'click', event, ->
      ...
      $(fundingStream).html('<div class="cta"><h3 class="uk-margin-remove white">Nice one!</h3>We\'re taking you to the funder, once you\'re done...<a class="uk-button uk-button-primary uk-width-1-1 uk-margin-top" href="/funders">Why not check out your next funder to approach?</a></div>');
