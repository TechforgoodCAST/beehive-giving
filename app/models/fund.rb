class Fund < ApplicationRecord
  ...
  has_and_belongs_to_many :restrictions, association_foreign_key: 'criterion_id', join_table: 'funds_questions'
  accepts_nested_attributes_for :restrictions
  has_and_belongs_to_many :priorities, association_foreign_key: 'criterion_id', join_table: 'funds_questions'
