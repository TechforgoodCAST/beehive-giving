...
ActiveAdmin.register FunderAttribute do
  permit_params :funder_id, :year, :grant_count, :application_count,
                :description, :enquiry_count, :funding_stream,
                :funding_size_average, :funding_size_min, :funding_size_max,
                :funding_duration_average, :funding_duration_min,
                :funding_duration_max, :funded_average_age,
                :funded_average_income, :funded_average_paid_staff,
                :beneficiary_min_age, :beneficiary_max_age, :funded_age_temp,
                :funded_income_temp, :application_link, :soft_restrictions,
                :application_details,
  ...
  form do |f|
    f.inputs do
      ...
      f.input :approval_months, as: :select,
                                input_html: { multiple: true,
                                              class: 'chosen-select' },
                                member_label: :month,
                                label: 'Approval Month(s)'
      f.input :funding_types, as: :select,
                              input_html: { multiple: true,
                                            class: 'chosen-select' },
                              member_label: :label,
                              label: 'Funding Type(s)'
      ...
      f.input :beneficiaries, as: :select,
                              input_html: { multiple: true,
                                            class: 'chosen-select' },
                              member_label: :label,
                              label: 'Beneficiaries'
